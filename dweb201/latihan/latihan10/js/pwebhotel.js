const endpoint_url='https://51018019.p-web.click/pweb201-prak8/api';
...
function getRoomRate() {
  fetch(endpoint_url + "/rooms/jumlahkamar")
    ...
    .then(function(data) {
      ...
      var tb_header = `
            <table id="tb_roomrate" class="striped highlight responsive-table">
              <thead>
                <tr>
                  <th>Room Type</th>
                  <th>Room Rate</th>
...
function getGuestsList() {
  fetch(endpoint_url + "/guests/guestslist")
    ...
    .then(function(data) {
      var tb_header = `
            <table id="tb_guestslist" class="striped highlight responsive-table">
              <thead>
                <tr>
                  <th>Guest</th>
                  <th>From</th>
...
function getMembersList() {
  fetch(endpoint_url + "/members/memberslist")
    .then(status)
    .then(json)
    .then(function(data) {
      var tb_header = `
            <table id="tb_memberslist" class="striped highlight responsive-table">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Nama</th>
...
function getMemberDetail(id) {
  fetch( endpoint_url + "/members/detail/id/" + id )
    .then(status)
    .then(json)
    .then(function(data) {
...
function getCountries() {
  fetch( endpoint_url + "/members/countrylist" )
    .then(status)
    .then(json)
    .then(function(data) {
...
function newMemberSave(){
  ...
  fetch( endpoint_url + "/members/newmember", {
    method: 'POST',
...
function memberCheckIn() {
  ...
  fetch( endpoint_url + "/members/checkedin", {
    method: 'POST',
